...
**Related Modules:**
- [Previous: 1.3 - Introduction to SailPoint ISC](../../../1.3-introduction-to-sailpoint-isc/1.3-introduction-to-sailpoint-isc.md) ISC fundamentals
- [Next: 1.5 - ISC Architecture Overview](../../../1.5-isc-architecture-overview/1.5-isc-architecture-overview.md) How ISC works internally
