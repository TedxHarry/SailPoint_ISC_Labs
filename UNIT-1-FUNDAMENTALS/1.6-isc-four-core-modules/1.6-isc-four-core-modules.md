...
**Related Modules:**
- [Next: 1.7 - ISC Data Model Fundamentals](../../../1.7-isc-data-model-fundamentals/1.7-isc-data-model-fundamentals.md) Data structures behind these modules
- [Next: 1.9 - The Identity Lifecycle (JML)](../../../1.9-the-identity-lifecycle-jml/1.9-the-identity-lifecycle-jml.md) Deep dive into Lifecycle Management
